...
const ThreeJSPointCloudComponent = () => {
  ...
  return (
    <div ref={mountRef} style={{ width: '100%', height: '100vh' }}>
      <div id="info">
       Interactive point map.   Built using <a href="https://threejs.org" target="_blank" rel="noopener">three.js</a> 
      </div>
    </div>
  );
};

export default ThreeJSPointCloudComponent;
